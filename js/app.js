...
var VALOR_ENTREGA = 5;
                    //pais/ddd
var CELULAR_EMPRESA = '5562982521468';
...
cardapio.metodos = {
    ...
    obterItensCardapio: (categoria = 'burgers', vermais = false) => {
        ...
        //remove active button categoria
    ...
    atualizarCarrinho: (id, qntd) => {
        ...
        // atualiza os valores de (R$) totais do carrinho
        cardapio.metodos.carregarValores();
    },
            ...
            if (validacep.test(cep)) {
                $.getJSON("https://viacep.com.br/ws/" + cep + "/json/?callback=?", function (dados) {
                    if (!("erro" in dados)) {
                        ...
                        cardapio.metodos.mensagem('CEP não econtrado. Preencha as informações manualmente.');
                        $("#txtEndereco").focus();
                    }
                })
            }
        ...
        if (MEU_CARRINHO.length > 0 && MEU_ENDERECO != null) {
            ...
            $.each(MEU_CARRINHO, (i, e) => {
                ...
                if ((i + 1) == MEU_CARRINHO.length) {
                   ...
                   //let URL https://api.whatsapp.com/send?phone=5562982521468&text=${encode}`;
...
cardapio.templates = {
    ...
    itemCarrinho: `
                ...
                <div class="dados-produto">
                    <p><b class="title-produto">\${name}</b></p>
                    <p><b class="price-produto">R$ \${price}</b></p>
                </div>
         ...
         <div class="col-12 item-carrinho resumo">
            <div class="img-produto-resumo">
                ...
                <div class="dados-produto">
                <p class="title-produto-resumo"><b>\${name}</
                b></p>
